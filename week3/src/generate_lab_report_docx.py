...
REPORT_MD = REPORT_DIR / "实验3-频率域滤波_实验报告.md"
REPORT_DOCX = REPORT_DIR / "实验3-频率域滤波_实验报告.docx"
...
def add_image(document: Document, alt: str, image_path: Path) -> None:
    ...
    if name == "70_all_results.png":
        width = Inches(6.4)
    elif name in {"50_freq_filter_compare_lpf.png", "51_freq_filter_compare_hpf.png"}:
        width = Inches(6.4)
    elif name in {"30_spatial_vs_freq_lowpass.png", "31_spatial_vs_freq_highpass.png",
                  "12_amp_phase_compare.png"}:
        width = Inches(6.4)
    elif name == "24_rect_filtering_compare.png":
        width = Inches(4.6)
