...
REPORT_MD = REPORT_DIR / "实验4-形态学处理_实验报告.md"
REPORT_DOCX = REPORT_DIR / "实验4-形态学处理_实验报告.docx"
...
def add_image(document: Document, alt: str, image_path: Path) -> None:
    ...
    if name == "60_all_results.png":
        width = Inches(6.4)
    elif name in {"50_basic_compare.png", "51_kernel_size_compare.png", "54_other_compare.png"}:
        width = Inches(6.4)
    elif name in {"52_open_close_compare.png", "53_boundary_compare.png", "55_hitmiss_compare.png"}:
        width = Inches(6.0)
    elif name in {"01_binary_original.png", "02_binary_noisy.png", "03_gray_original.png", "04_hitmiss_source.png"}:
        width = Inches(4.2)
