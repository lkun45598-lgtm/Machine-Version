...
REPORT_MD = REPORT_DIR / "实验2-空间域邻域滤波_实验报告.md"
REPORT_DOCX = REPORT_DIR / "实验2-空间域邻域滤波_实验报告.docx"
...
def add_image(document: Document, alt: str, image_path: Path) -> None:
    ...
    if name == "70_all_results.png":
        width = Inches(6.4)
    elif name in {"40_smoothing_compare.png", "42_gaussian_size_compare.png", "51_edge_directions.png"}:
        width = Inches(6.4)
    elif name == "50_sharpening_compare.png":
        width = Inches(6.5)
    elif name == "60_algebraic_compare.png":
        width = Inches(6.2)
    elif name in {"01_original.png", "02_noisy.png", "03_blurred.png", "27_laplacian_sharpen.png"}:
        width = Inches(4.2)
